...
from gui.tour.scrolled_text import ScrolledText
...
class GuiMixin:
    ...
    def selectOpenFile(self, file="", dir_="."):
        return askopenfilename(initialdir=dir_, initialfile=file)

    def selectSaveFile(self, file='', dir_='.'):
        return asksaveasfilename(initialfile=file, initialdir=dir_)
...
if __name__ == '__main__':
    ...
    class TestMixin(GuiMixin, Frame):
        def __init__(self, master=None):
            super(TestMixin, self).__init__(master)
            self.pack()
