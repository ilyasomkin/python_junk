...
import os
from tkinter import *
from gui.tools.guimixin import *
...
class Hello(GuiMixin, GuiMakerWindowMenu):
  def start(self):
    ...
    def spawnme(): self.spawn('big_gui.py')
    ...
    self.menuBar = [
        ...
        ('Play', 0,
         [('Hello', 0, self.greeting),
          ...
          ('Demos', 0,
           [('Toplevels', 0,
             lambda: self.spawn(r'../tour/toplevel2.py')),
            ('Frames', 0,
             lambda: self.spawn(r'../tour/demoAll_form.py')),
            ('Images', 0,
             lambda: self.spawn(r'../tour/button_pics.py')),
            ('Alarm', 0,
